...
def create_final_shop_hub_presentation():
    # Create presentation
    prs = Presentation()
    ...
    purple_color = RGBColor(147, 51, 234)  # Purple
    ...
    # Apply enhanced styling to title
    title_frame = title.text_frame
    title_frame.paragraphs[0].font.size = Pt(48)
    title_frame.paragraphs[0].font.color.rgb = primary_color
    title_frame.paragraphs[0].font.bold = True
    
    # Apply enhanced styling to subtitle
    subtitle_frame = subtitle.text_frame
    subtitle_frame.paragraphs[0].font.size = Pt(28)
    subtitle_frame.paragraphs[0].font.color.rgb = dark_color
    subtitle_frame.paragraphs[1].font.size = Pt(20)
...
• Ensure responsive design for all device types"""
    ...
    # Slide 3: Key Features with enhanced icons
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Efficient state management"""
    ...
    # Slide 5: Application Screenshots - Login Page (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
    
    # Add enhanced title
    title_box = slide.shapes.add_textbox(Inches(1), Inches(0.3), Inches(8), Inches(1.2))
    ...
    # Add enhanced placeholder for login screenshot
    ...
    img_frame.paragraphs[0].font.size = Pt(20)
    img_frame.paragraphs[0].font.color.rgb = accent_color
    img_frame.paragraphs[0].font.bold = True
    img_frame.paragraphs[0].alignment = PP_ALIGN.CENTER
    img_frame.paragraphs[2].font.size = Pt(16)
    img_frame.paragraphs[2].font.color.rgb = secondary_color
    img_frame.paragraphs[2].alignment = PP_ALIGN.CENTER
    img_frame.paragraphs[4].font.size = Pt(12)
    img_frame.paragraphs[4].font.color.rgb = dark_color
    img_frame.paragraphs[4].alignment = PP_ALIGN.CENTER
    img_frame.paragraphs[4].font.italic = True
    
    # Slide 6: Application Screenshots - Homepage (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
    ...
    # Add enhanced placeholder for homepage screenshot
    img_box = slide.shapes.add_textbox(Inches(1), Inches(2), Inches(8), Inches(5))
    img_frame = img_box.text_frame
    ...
    # Slide 7: Application Screenshots - Product Page (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
    ...
    # Add enhanced placeholder for product page screenshot
    img_box = slide.shapes.add_textbox(Inches(1), Inches(2), Inches(8), Inches(5))
    img_frame = img_box.text_frame
    ...
    # Slide 8: Application Screenshots - Cart Page (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
    ...
    # Add enhanced placeholder for cart page screenshot
    img_box = slide.shapes.add_textbox(Inches(1), Inches(2), Inches(8), Inches(5))
    img_frame = img_box.text_frame
    ...
    # Slide 9: System Architecture Diagram (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
...
• Cart persistence across sessions"""
    ...
    # Slide 11: Non-Functional Requirements (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Consistent behavior across different browsers"""
    ...
    # Slide 12: Development Methodology (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
4. Testing Phase
   ...
   • Performance testing"""
    ...
    # Slide 13: Testing Strategy (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Optimized JavaScript bundle"""
    ...
    # Slide 14: Project Achievements (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Secure user data handling and authentication"""
    ...
    # Slide 15: Lessons Learned (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Small details like loading states and error handling significantly impact UX"""
    ...
    # Slide 16: Future Improvements (Enhanced)
    slide = prs.slides.add_slide(content_slide_layout)
    title = slide.shapes.title
    content = slide.placeholders[1]
...
• Advanced Analytics and Reporting"""
    ...
    # Slide 17: Project Links and Demo (Enhanced)
    slide = prs.slides.add_slide(blank_layout)
    ...
    links_frame.paragraphs[0].font.size = Pt(20)
...
Questions & Discussion"""
    ...
    prs.save('Shop_Hub_Final_Presentation.pptx')
    print("Final enhanced PowerPoint presentation created successfully: Shop_Hub_Final_Presentation.pptx")
    print("\n📝 Instructions for adding screenshots:")
    print("1. Open the presentation in PowerPoint")
    print("2. Replace the placeholder text boxes with actual screenshots")
    print("3. Right-click on placeholder → Delete → Insert → Picture")
    print("4. Select your application screenshots")
    print("5. Resize and position as needed")

if __name__ == "__main__":
    create_final_shop_hub_presentation() 